...
extension Color {
    ...
    var fontColor: Color {
        ...
        case Color(0xB237BB), Color(0xC93DEB), Color(0xB34CED):
            fallthrough
        case Color(0x4C45FF), Color(0x2E57FF), Color(0x4D8DFF):
            fallthrough
        case Color(0xC22E2E):
            fallthrough
        ...
        case Color(0x9D5BE3), Color(0xBB93F8), Color(0xC6B2FF):
            fallthrough
        case Color(0x45BDFF), Color(0x6DDDFF), Color(0x65F4FF):
            fallthrough
        case Color(0xFE7E7E), Color(0xFF572E), Color(0xA07753), Color(0xE3942E), Color(0xE8A753):
            fallthrough
